...
class TestComlinkGridInterpolator(unittest.TestCase):
    def test_default_idw(self):
        ...
        np.testing.assert_array_almost_equal(
            ...
            np.array(
                [[0.0, 0.0, 0.0], [0.02679148, 0.0, 0.0], [0.17902197, 0.10871572, 0.0]]
            ),
        )
    ...
    def test_default_idw_aggregated_to_new_index(self):
        ...
        np.testing.assert_array_almost_equal(
            ...
            np.array(
                [
                    [0.01552989, 0.09481763, 0.15710547],
        ...
        np.testing.assert_array_almost_equal(
            ...
            np.array(
                [
                    [2.64776423, 2.27544954, 1.96875187],
    ...
    def test_default_kriging(self):
        ...
        interpolator = pycml.spatial.interpolator.ComlinkGridInterpolator(
            ...
            resolution=0.05,
            interpolator=(
                pycml.spatial.interpolator.OrdinaryKrigingInterpolator(backend="loop")
            ),
        )
